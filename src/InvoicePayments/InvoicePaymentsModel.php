...
class InvoicePaymentsModel implements JsonSerializable
{
    private int $id;
    ...
    public function __construct(InvoicePaymentsDto $dto = null)
    {
        if ($dto === null) {
            return;
        }
    ...
    public function toDto(): InvoicePaymentsDto
    {
        $dto = new InvoicePaymentsDto();
