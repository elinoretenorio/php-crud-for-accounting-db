...
use Accounting\Bills\{ BillsDto, IBillsRepository, BillsRepository };

class BillsRepositoryTest extends TestCase
{
    private $db;
    private $result;
    private array $input;
    ...
    protected function setUp(): void
    {
        ...
        $this->input = [
            "id" => 6581,
            "tran_date" => "2021-09-22",
            "due_date" => "2021-10-01",
            "description" => "Minute final specific upon. Quickly police parent kitchen stay section become action.",
            "reference" => "Director model her network.",
            "total" => 421.73,
            "status" => True,
            "supplier_id" => 3923,
            "bill_payment_id" => 3880,
            "coa_id" => 9323,
        ];
        $this->dto = new BillsDto($this->input);
        $this->repository = new BillsRepository($this->db);
    }
